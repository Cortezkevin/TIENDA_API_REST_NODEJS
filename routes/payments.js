...
const { validatorGetItem, validatorCreateItem } = require("../validators/paymentValidator");
const checkRole = require("../middleware/roleMiddleware");
const authMiddleware = require("../middleware/sessionMiddleware");
const { getAllItems, getItem, createItem, updateItem, deleteItem } = require("../controllers/paymentsController");
